...
\begin{description}
    \item[TAM (Total Addressable Market): USD 4.32 Miliardi (2024)] Mercato globale dei dispositivi di monitoraggio della salute mentale (MetaTech Insights, 2025). Proiezione a 5 anni con CAGR 13.8\%:
    $$TAM_{2029} = 4.32 \times (1.138)^5 = 4.32 \times 1.908 \approx \text{USD } 8.24 \text{ Mld}$$
    
    \item[SAM (Serviceable Addressable Market): USD 2.66 Miliardi] Europa + Nord America, i mercati dove LIMEN opererà inizialmente. Quote regionali dal report MetaTech Insights (2024): Europa USD 1.21 Mld + Nord America USD 1.45 Mld = USD 2.66 Mld, pari al 61.6\% del TAM globale.
